...
export default function AgentRegistrationModal({ open, onOpenChange, event, user }) {
  ...
  const isFormValid = () => {
    return formData.agencyName && formData.contactName && formData.contactEmail && formData.phone;
  };
  ...
  const createRegistration = async (paymentMethod, status, bankProofUrl = null) => {
    try {
      ...
      const newReg = {
        ...
        organization_name: formData.agencyName,
        amount_usd: 250,
        ...
        ticket_qr_url: status === 'paid' ? `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${event.event_id}-AGENT-${user.id}` : null,
      };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">GAIN Fair 2025 - Agent Registration</DialogTitle>
        </DialogHeader>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Register your agency for GAIN Fair 2025. Connect with schools, showcase your services, and network with international partners.</p>
                </div>
